      ...
      <div class="col-xl-12 col-lg-12">
        <div class="card">
          <div class="card-body  pb-5">
            ...
            <form  method="POST" action="{{route('student.edit',$result->id)}}" enctype="multipart/form-data" id="addForm">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="first_name" class="form-control" placeholder="Enter First Name" value="{{ $result->first_name }}" required>
                ...
                <div class="row">    
                    <div class="col-md-6 mt-3">
                        <div class="form-group">
                            <label >Age</label>
                            <input type="tel" name="age" class="form-control" placeholder="Enter Age" value="{{ old('age',$result->age) }}">
                            <span class="error-message"></span>
                        </div>
                    </div>
                    <div class="col-md-6 mt-3">
                        <div class="form-group">
                            <label >City</label>
                            <input type="tel" name="city" class="form-control" placeholder="Enter City" value="{{ old('city',$result->city) }}">
                            <span class="error-message"></span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    ...
                                    <img src="{{asset('uploads/'.$result->photo)}}" class="img-thumbnail" width="100">
                                </div>
                            </div>
                            <span class="error-message"></span>
                        </div>
